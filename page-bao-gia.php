<?php
/* Template Name: Yêu cầu báo giá VinFast */
get_header(); ?>
...
<div class="testdrive-page">
    <div class="testdrive-container">
        <h1 class="td-section-title">Yêu cầu báo giá</h1>

        <!-- Nhúng Shortcode Contact Form 7 -->
        <?php echo do_shortcode('[contact-form-7 id="100" title="Đăng ký nhận báo giá"]'); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const carImages = {
        ...
        $query = new WP_Query(array('post_type' => 'product', 'post__in' => $active_ids, 'posts_per_page' => -1));
